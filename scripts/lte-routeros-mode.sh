...
# ==============================================================================
# Quickly run on device:
#   lte-mode.sh
# or from host / curl:
#   curl -fsSL https://raw.githubusercontent.com/hungngit2/msm8916-openwrt/main/scripts/lte-routeros-mode.sh | sudo sh
# ==============================================================================
# Modes:
#   1) RouterOS Passthrough (Telit LN940 1bc7:1901) - NCM Ethernet + AT Bridge
#   2) RouterOS Passthrough (Quectel EC25 2c7c:0125) - NCM Ethernet + AT Bridge
#   3) RouterOS Passthrough (Qualcomm 05c6:9025)   - NCM Ethernet + AT Bridge
#   4) OpenWrt Router Mode  (Linux 1d6b:0104)      - NCM Ethernet + Login Shell
# ==============================================================================
...
show_status() {
    ...
    # Live AT Query if port is available and bridge/MM allows
...
apply_mode() {
    ...
    case "$target" in
        ...
        openwrt)
            ...
            # Re-enable OpenWrt ModemManager
